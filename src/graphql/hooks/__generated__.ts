 ...
 *      selectedBrands: // value for 'selectedBrands'
 *   },
 * });
 */
export function useFilterProductsQuery(
  baseOptions?: Apollo.QueryHookOptions<FilterProductsQuery, FilterProductsQueryVariables>
) {
...
export function useFilterProductsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<FilterProductsQuery, FilterProductsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useFilterProductsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<FilterProductsQuery, FilterProductsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<FilterProductsQuery, FilterProductsQueryVariables>(
    FilterProductsDocument,
    options
  );
}
...
export type FilterProductsSuspenseQueryHookResult = ReturnType<
  typeof useFilterProductsSuspenseQuery
>;
...
export function useGetBrandsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetBrandsQuery, GetBrandsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useGetBrandsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<GetBrandsQuery, GetBrandsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
/**
 * __useGetNavLinksQuery__
 *
 * To run a query within a React component, call `useGetNavLinksQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetNavLinksQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetNavLinksQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetNavLinksQuery(
  baseOptions?: Apollo.QueryHookOptions<GetNavLinksQuery, GetNavLinksQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetNavLinksQuery, GetNavLinksQueryVariables>(GetNavLinksDocument, options);
}
export function useGetNavLinksLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetNavLinksQuery, GetNavLinksQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetNavLinksQuery, GetNavLinksQueryVariables>(
    GetNavLinksDocument,
    options
  );
}
export function useGetNavLinksSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<GetNavLinksQuery, GetNavLinksQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetNavLinksQuery, GetNavLinksQueryVariables>(
    GetNavLinksDocument,
    options
  );
}
export type GetNavLinksQueryHookResult = ReturnType<typeof useGetNavLinksQuery>;
export type GetNavLinksLazyQueryHookResult = ReturnType<typeof useGetNavLinksLazyQuery>;
export type GetNavLinksSuspenseQueryHookResult = ReturnType<typeof useGetNavLinksSuspenseQuery>;
export type GetNavLinksQueryResult = Apollo.QueryResult<
  GetNavLinksQuery,
  GetNavLinksQueryVariables
>;
...
export function useGetProductsSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<GetProductsQuery, GetProductsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
