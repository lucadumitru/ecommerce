...
(exports.id = 271),
  ...
  (exports.modules = {
      ...
      (() => {
        var t = {
            ...
            277: (e, t, r) => {
              ...
              let n = r(491),
                a = r(780),
                o = (0, a.createContextKey)("OpenTelemetry Baggage Key");
              function i(e) {
            ...
            172: (e, t, r) => {
              ...
              (t.registerGlobal = function (e, t, r, n = !1) {
                var o;
                let i = (l[s] = null !== (o = l[s]) && void 0 !== o ? o : { version: a.VERSION });
                if (!n && i[e]) {
                  let t = Error(
            ...
            614: (e, t, r) => {
              ...
              class l {
                startSpan(e, t, r = s.active()) {
                  ...
                  if (n) return new o.NonRecordingSpan();
                  let l = r && (0, a.getSpanContext)(r);
                  return "object" == typeof l &&
                    "string" == typeof l.spanId &&
                    "string" == typeof l.traceId &&
                    "number" == typeof l.traceFlags &&
            ...
            846: (e, t, r) => {
              ...
              let n = r(125),
                a = r(124),
                o = new a.NoopTracerProvider();
              class i {
                getTracer(e, t, r) {
                  var a;
                  return null !== (a = this.getDelegateTracer(e, t, r)) && void 0 !== a
                    ? a
    ...
    6106: (e, t) => {
      ...
      let { env: n, stdout: a } = (null == (r = globalThis) ? void 0 : r.process) ?? {},
        o =
          n &&
          !n.NO_COLOR &&
          (n.FORCE_COLOR || ((null == a ? void 0 : a.isTTY) && !n.CI && "dumb" !== n.TERM)),
        i = (e, t, r, n) => {
        ...
        u = o ? s("\x1b[1m", "\x1b[22m", "\x1b[22m\x1b[1m") : String,
        c = o ? s("\x1b[2m", "\x1b[22m", "\x1b[22m\x1b[2m") : String,
        d = o ? s("\x1b[3m", "\x1b[23m") : String,
        g = o ? s("\x1b[4m", "\x1b[24m") : String,
        p = o ? s("\x1b[7m", "\x1b[27m") : String,
        f = o ? s("\x1b[8m", "\x1b[28m") : String,
        _ = o ? s("\x1b[9m", "\x1b[29m") : String,
        v = o ? s("\x1b[30m", "\x1b[39m") : String,
        S = o ? s("\x1b[31m", "\x1b[39m") : String,
        b = o ? s("\x1b[32m", "\x1b[39m") : String,
        h = o ? s("\x1b[33m", "\x1b[39m") : String,
        O = o ? s("\x1b[34m", "\x1b[39m") : String,
        E = o ? s("\x1b[35m", "\x1b[39m") : String,
        P = o ? s("\x1b[38;2;173;127;168m", "\x1b[39m") : String,
        R = o ? s("\x1b[36m", "\x1b[39m") : String,
        T = o ? s("\x1b[37m", "\x1b[39m") : String,
        m = o ? s("\x1b[90m", "\x1b[39m") : String,
        N = o ? s("\x1b[40m", "\x1b[49m") : String,
        x = o ? s("\x1b[41m", "\x1b[49m") : String,
        y = o ? s("\x1b[42m", "\x1b[49m") : String,
        C = o ? s("\x1b[43m", "\x1b[49m") : String,
        A = o ? s("\x1b[44m", "\x1b[49m") : String,
        I = o ? s("\x1b[45m", "\x1b[49m") : String,
        M = o ? s("\x1b[46m", "\x1b[49m") : String,
        D = o ? s("\x1b[47m", "\x1b[49m") : String;
    },
    6132: (e, t) => {
      var r;
    ...
    1040: (e, t, r) => {
        ...
        for (let t of e)
          "string" != typeof t
            ...
            : t.length > o.NEXT_CACHE_TAG_MAX_LENGTH
              ? n.push({ tag: t, reason: `exceeded max length of ${o.NEXT_CACHE_TAG_MAX_LENGTH}` })
              : r.push(t);
        if (n.length > 0)
      ...
      function d(e) {
        ...
        if ((Array.isArray(e.tags) || (e.tags = []), a)) {
          let r = c(a);
          for (let a of r)
            (a = `${o.NEXT_CACHE_IMPLICIT_TAG_ID}${a}`),
              (null == (t = e.tags) ? void 0 : t.includes(a)) || e.tags.push(a),
              n.push(a);
        }
        if (i) {
      ...
      function p({ serverHooks: e, staticGenerationAsyncStorage: t }) {
        if (
          (globalThis._nextOriginalFetch || (globalThis._nextOriginalFetch = globalThis.fetch),
          globalThis.fetch.__nextPatched)
        )
          return;
        let { DynamicServerError: r } = e,
          l = globalThis._nextOriginalFetch;
        (globalThis.fetch = async (e, c) => {
          var p, f;
          let _;
          try {
            ((_ = new URL(e instanceof Request ? e.url : e)).username = ""), (_.password = "");
          } catch {
            _ = void 0;
          }
          let v = (null == _ ? void 0 : _.href) ?? "",
            S = Date.now(),
            b = (null == c ? void 0 : null == (p = c.method) ? void 0 : p.toUpperCase()) || "GET",
            h = (null == (f = null == c ? void 0 : c.next) ? void 0 : f.internal) === !0;
          return await (0, a.getTracer)().trace(
            h ? n.NextNodeServerSpan.internalFetch : n.AppRenderSpan.fetch,
            {
            ...
            async () => {
              ...
              let _ =
                ...
                O = (t) => (b ? e[t] : null) || (null == c ? void 0 : c[t]);
              if (!_ || h || _.isDraftMode) return l(e, c);
              let E = (t) => {
                  var r, n, a;
                  return void 0 !== (null == c ? void 0 : null == (r = c.next) ? void 0 : r[t])
                    ? null == c
                      ? void 0
                      : null == (n = c.next)
                        ? void 0
                ...
                P = E("revalidate"),
                R = u(E("tags") || [], `fetch ${e.toString()}`);
              if (Array.isArray(R))
                for (let e of (_.tags || (_.tags = []), R)) _.tags.includes(e) || _.tags.push(e);
              let T = d(_),
                m = "only-cache" === _.fetchCache,
                N = "force-cache" === _.fetchCache,
                x = "default-cache" === _.fetchCache,
                y = "default-no-store" === _.fetchCache,
                C = "only-no-store" === _.fetchCache,
                A = "force-no-store" === _.fetchCache,
                I = O("cache"),
                M = "";
              "string" == typeof I &&
                void 0 !== P &&
                ((b && "default" === I) ||
                  i.warn(
                    `fetch for ${v} on ${_.urlPathname} specified "cache: ${I}" and "revalidate: ${P}", only one should be specified.`
                  ),
                (I = void 0)),
                "force-cache" === I
                  ? (P = !1)
                  : ("no-cache" === I || "no-store" === I || A || C) && (P = 0),
                ("no-cache" === I || "no-store" === I) && (M = `cache: ${I}`),
                ("number" == typeof P || !1 === P) && (f = P);
              let D = O("headers"),
                L = "function" == typeof (null == D ? void 0 : D.get) ? D : new Headers(D || {}),
                w = L.get("authorization") || L.get("cookie"),
                j = !["get", "head"].includes(
                  (null == (n = O("method")) ? void 0 : n.toLowerCase()) || "get"
                ),
                V = (w || j) && 0 === _.revalidate;
              if ((A && (M = "fetchCache = force-no-store"), C)) {
                if ("force-cache" === I || (void 0 !== f && (!1 === f || f > 0)))
                  throw Error(
              ...
              N && (void 0 === P || 0 === P) && ((M = "fetchCache = force-cache"), (f = !1)),
                void 0 === f
                  ? x
                ...
                !V &&
                  (void 0 === _.revalidate ||
                    ("number" == typeof f &&
                      (!1 === _.revalidate ||
                        ("number" == typeof _.revalidate && f < _.revalidate)))) &&
                  (0 === f && (0, s.maybePostpone)(_, "revalidate: 0"), (_.revalidate = f));
              let B = ("number" == typeof f && f > 0) || !1 === f;
              if (_.incrementalCache && B)
                try {
                  a = await _.incrementalCache.fetchCacheKey(v, b ? e : c);
                } catch (t) {
                  console.error("Failed to generate cache key for", e);
                }
              let G = _.nextFetchId ?? 1;
              _.nextFetchId = G + 1;
              let U = "number" != typeof f ? o.CACHE_ONE_YEAR : f,
                H = async (t, r) => {
                  let n = [
                    "cache",
                    "credentials",
                  ...
                  if (b) {
                    ...
                    let e = c;
                    for (let t of ((c = { body: c._ogBody || c.body }), n)) c[t] = e[t];
                  }
                  let o = {
                    ...c,
                    next: { ...(null == c ? void 0 : c.next), fetchType: "origin", fetchIdx: G }
                  };
                  return l(e, o).then(async (n) => {
                    if (
                      ...
                      200 === n.status && _.incrementalCache && a && B)
                    ) {
                      ...
                      try {
                        await _.incrementalCache.set(
                          ...
                          { fetchCache: !0, revalidate: f, fetchUrl: v, fetchIdx: G, tags: R }
                        );
                      } catch (t) {
                      ...
                      return Object.defineProperty(r, "url", { value: n.url }), r;
                    }
                    return n;
                  });
                },
              ...
              if (a && _.incrementalCache) {
                F = await _.incrementalCache.lock(a);
                ...
                if (
                  ...
                  (null == e ? void 0 : e.value) &&
                    "FETCH" === e.value.kind &&
                    !(_.isRevalidate && e.isStale))
                ) {
                  e.isStale &&
                    (_.pendingRevalidates || (_.pendingRevalidates = []),
                    _.pendingRevalidates.push(H(!0).catch(console.error)));
                  let t = e.value.data;
                  g(_, {
                    start: S,
                    url: v,
              ...
              if (_.isStaticGeneration && c && "object" == typeof c) {
                let { cache: t } = c;
                if ("no-store" === t) {
                  let t = `no-store fetch ${e}${_.urlPathname ? ` ${_.urlPathname}` : ""}`,
                    n = new r(t);
                  (_.dynamicUsageErr = n),
                    (_.dynamicUsageStack = n.stack),
                    (_.dynamicUsageDescription = t),
                    (0, s.maybePostpone)(_, t),
                    (_.revalidate = 0);
                }
                let n = "next" in c,
                  { next: a = {} } = c;
                if (
                  ...
                  (void 0 === _.revalidate ||
                    ("number" == typeof _.revalidate && a.revalidate < _.revalidate))
                ) {
                  let t = _.forceDynamic;
                  if (!t && 0 === a.revalidate) {
                    let t = `revalidate: 0 fetch ${e}${_.urlPathname ? ` ${_.urlPathname}` : ""}`,
                      n = new r(t);
                    (_.dynamicUsageErr = n),
                      (_.dynamicUsageStack = n.stack),
                      (_.dynamicUsageDescription = t),
                  ...
                  (t && 0 === a.revalidate) || (_.revalidate = a.revalidate);
                }
                n && delete c.next;
              }
              return H(!1, p).finally(F);
            }
          );
        }),
    ...
    4640: (e, t, r) => {
      ...
      class S {
        ...
        withPropagatedContext(e, t) {
          if (o.active() !== c) return t();
          let r = i.extract(c, e.headers);
          return o.with(r, t);
        }
        trace(...e) {
          var t;
          ...
          let _ = u.spanName ?? r,
            ...
            b = !1;
          S
            ? (null == (t = s.getSpanContext(S)) ? void 0 : t.isRemote) && (b = !0)
            : ((S = c), (b = !0));
          let h = v();
          return (
            (u.attributes = { "next.span_name": _, "next.span_type": r, ...u.attributes }),
        ...
        getSpanContext(e) {
          let t = e ? s.setSpan(o.active(), e) : void 0;
          return t;
        }
